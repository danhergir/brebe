        ...
        <div class="radial-stepper hidden mx-auto text-center">
            <ol class="mx-auto text-center w-full space-y-4 sm:flex sm:space-x-8 sm:space-y-0 rtl:space-x-reverse">
                <li class="mx-auto text-center text-blue-600 dark:text-blue-500 space-x-2.5 rtl:space-x-reverse">
                    <button type="button" class="text-white bg-blue-600 border font-medium rounded-full text-md px-5 py-2.5 text-center mb-2">1 de 5</button>
                    <span>
                        {{-- <h3 class="font-medium text-2xl text-center">Información Personal</h3> --}}
                        <p class="text-sm text-center text-blue-600 mt-2">Siguiente paso: Ubicación</p>
                    </span>
                </li>
            </ol>            
        </div>    
            ...
            <form action="{{ route('user.save-1') }}" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input readonly value="{{ old('birthdate', $user['birthdate'] ?? '') }}" datepicker datepicker-orientation="top left" maxlength="10" id="birthdate" autocomplete="off" datepicker-format="dd/mm/yyyy" name="birthdate" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Seleccione fecha">
                        @error('birthdate')
                            <span class="text-red-600">{{ $message }}</span>
                        @enderror
                    </div>
